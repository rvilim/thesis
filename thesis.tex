...
\documentclass[twoside,openright]{ut-thesis} % The printable version of the thesis
%\documentclass{ut-thesis} % The E-Version of the thesis
...
\gradyear{2015}
\author{Ryan Vilim}
\title{The Effect of Material Properties on Dynamo Generation in Planets}
